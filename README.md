...
| [Brgvos Gnome Shell Note](https://samwhelp.github.io/note-about-brgvos-gnome-shell/) | [GitHub](https://github.com/samwhelp/note-about-brgvos-gnome-shell) |
...
| Script |
| ------ |
| [Brgvos Gnome Shell Config](https://github.com/samwhelp/brgvos-gnome-shell-adjustment/tree/main/prototype/main/gnome-shell-config/part/Main) |
| [Tool Config](https://github.com/samwhelp/brgvos-adjustment/tree/main/prototype/main/tool-config/part) |
| [gnome-shell-adjustment](https://github.com/samwhelp/brgvos-gnome-shell-adjustment/tree/main/demo/scripts/main/gnome-shell-adjustment) |
...
| Gnome Shell Layout Switcher |
| --------------------------- |
| Brgvos / [/usr/local/bin/setTheme*.sh](https://github.com/florintanasa/brgvos-void/tree/main/includedir/usr/local/bin) |
| brgvos-gnome-shell-adjustment / [layout](https://github.com/samwhelp/brgvos-gnome-shell-adjustment/tree/main/demo/scripts/appearance/layout/Advance) |
| pardus-gnome-greeter / [LayoutManager](https://github.com/pardus/pardus-gnome-greeter/blob/master/src/pardus_gnome_greeter/managers/LayoutManager.py) / [layout_config.json](https://github.com/pardus/pardus-gnome-greeter/blob/master/data/json/layout_config.json) |
